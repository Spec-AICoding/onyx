...
from onyx.configs.constants import POSTGRES_CELERY_WORKER_GRAPH_PROCESSING_APP_NAME
...
celery_app.config_from_object("onyx.background.celery.configs.graph_processing")
...
def on_worker_init(sender: Worker, **kwargs: Any) -> None:
    ...
    SqlEngine.set_app_name(POSTGRES_CELERY_WORKER_GRAPH_PROCESSING_APP_NAME)
...
celery_app.autodiscover_tasks(
    app_base.filter_task_modules(
        [
            "onyx.background.celery.tasks.graph_processing",
        ]
    )
)
